  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <PageContainer className="relative">
        {/* HERO (redesigned: cleaner + less clustered) */}
        <section className="py-10 sm:py-16">
          {/* Main hero panel */}
          <div className="relative overflow-hidden rounded-3xl border border-border/60 bg-card/35 backdrop-blur-xl">
            {/* gradient layer */}
            <div className="absolute inset-0">
              <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(250,204,21,0.14),transparent_48%,rgba(99,102,241,0.10))]" />
              <div className="absolute inset-0 bg-[radial-gradient(900px_circle_at_10%_15%,rgba(99,102,241,0.16),transparent_55%)]" />
              <div className="absolute inset-0 bg-[radial-gradient(800px_circle_at_92%_25%,rgba(250,204,21,0.18),transparent_55%)]" />
            </div>
            ...
            <div className="relative p-6 sm:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
                ...
                {/* Right: ONE preview card (no more stacked cards) */}
                <div className="relative">
                  ...
                  <Card className="relative rounded-2xl border-border/60 bg-background/55 backdrop-blur-xl shadow-sm">
                    <CardContent className="p-6">
                      ...
                      <div className="mt-5 rounded-xl border border-border/60 bg-muted/15 p-3 text-sm text-muted-foreground leading-6">
          ...
          {/* Supporting strip (moved OUT of the hero card to reduce clutter) */}
